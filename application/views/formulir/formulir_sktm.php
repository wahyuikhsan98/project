...
<form enctype="multipart/form-data" class="needs-validation" style="background:#f5f5f5;border:3px dashed #777;border-radius:10px; padding:15px 10px" method="post" action="https://simpel.kelurahankota.bengkaliskab.go.id/buat/surat-keterangan-tidak-mampu" novalidate>
    ...
    <div class="row">
        <div class="col-12">
            <h5 class="mb-3 pb-3" style="color:#444;border-bottom:3px dashed #777">
                <center>Formulir Permohonan<br> <b>Surat Keterangan Tidak Mampu</b></center>
            </h5>
        ...
        <div class="col-md-6  col-6">
            <small class="text-muted" for="firstName">RW Pemohon</small>
        ...
        <div class="col-md-6 col-6">
            <small class="text-muted" for="firstName">RT Pemohon</small>
        ...
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Nama anak yang sekolah </small>
            <input type="Text" class="form-control " placeholder="Masukkan Nama anak yang sekolah" name="nama_anak_yang_sekolah" required>

        </div>
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Kartu Keluarga <i class="text-warning">(?) Scan atau Foto</i></small>
            <input onchange="fileselect('kartu_keluarga')" required type="File" class="form-control " id="kartu_keluarga" name="kartu_keluarga">
        </div>
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Tanggal Kartu Keluarga </small>
            <input type="Date" class="form-control " placeholder="Masukkan Tanggal Kartu Keluarga" name="tanggal_kartu_keluarga" required>

        </div>
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">KTP <i class="text-warning">(?) Scan atau Foto</i></small>
            <input onchange="fileselect('ktp')" required type="File" class="form-control " id="ktp" name="ktp">
        </div>
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Tanggal KTP </small>
            <input type="Date" class="form-control " placeholder="Masukkan Tanggal KTP" name="tanggal_ktp" required>
