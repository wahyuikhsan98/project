...
<form enctype="multipart/form-data" class="needs-validation" style="background:#f5f5f5;border:3px dashed #777;border-radius:10px; padding:15px 10px" method="post" action="https://simpel.kelurahankota.bengkaliskab.go.id/buat/surat-keterangan-usaha" novalidate>
    ...
    <div class="row">
        <div class="col-12">
            <h5 class="mb-3 pb-3" style="color:#444;border-bottom:3px dashed #777">
                <center>Formulir Permohonan<br> <b>Surat Keterangan Usaha</b></center>
            </h5>
        ...
        <div class="col-md-6  col-6">
            <small class="text-muted" for="firstName">RW Tempat Usaha</small>
        ...
        <div class="col-md-6 col-6">
            <small class="text-muted" for="firstName">RT Tempat Usaha</small>
        ...
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Kegunaan <i class="text-warning">(?) Kegunaan pembuatan surat ini</i></small>
            <input type="Text" class="form-control " placeholder="Masukkan Kegunaan" name="kegunaan" required>

        </div>
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Nama Usaha </small>
            <input type="Text" class="form-control " placeholder="Masukkan Nama Usaha" name="nama_usaha" required>

        </div>
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Alamat Usaha </small>
            <input type="Text" class="form-control " placeholder="Masukkan Alamat Usaha" name="alamat_usaha" required>

        </div>
        <div class="col-12  mt-3">
            <h6 for="" style="border-bottom:2px dotted #111">Upload Persyaratan : (<small class="text-danger">Silahkan Upload Berkas yang diminta dibawah ini :</small>)</h6>
        ...
        <div class="col-md-6 col-12">
            <small class="text-muted" for="firstName">Foto Tempat Usaha </small>
            <input onchange="fileselect('foto_tempat_usaha')" required type="File" class="form-control " id="foto_tempat_usaha" name="foto_tempat_usaha">
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Syarat-syarat administrasi pengurusan melalui Sistem Pelayanan (Simpel) Kelurahan Kota Bengkalis sebagai berikut :</p>
                <ol>
                    <li><span style="line-height: 16.8667px;">Dokumen/Foto/Hasil Scan Kartu Keluarga (KK);</span></li>
                    <li><span style="line-height: 16.8667px;">Dokumen/Foto/Hasil Scan&nbsp;Kartu Tanda Penduduk (KTP);</span></li>
                    <li><span style="line-height: 16.8667px;">Dokumen/Foto/Hasil Scan&nbsp;Online Single Submission (OSS) bagi usaha menengah ke atas; dan</span></li>
                    <li><span style="line-height: 16.8667px;">Dokumen/Foto/Hasil Scan gambar tempat usaha.</span></li>
                </ol>
            </div>
